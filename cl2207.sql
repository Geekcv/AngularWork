...
-- Started on 2025-07-22 22:06:27
...
SELECT pg_catalog.setval('school_schema.chapters_id_seq', 6, true);
...
SELECT pg_catalog.setval('school_schema.class_id_seq', 15, true);
...
SELECT pg_catalog.setval('school_schema.schools_id_seq', 9, true);
...
SELECT pg_catalog.setval('school_schema.subjects_id_seq', 9, true);
...
SELECT pg_catalog.setval('school_schema.users_id_seq', 9, true);
...
-- Completed on 2025-07-22 22:06:28
